<script setup>
	import Order from "@/components/dashboard/laundry/Order.vue";
	...
	function loadStats(stat, selected) {
							...
							<div class="card card-stretch mb-5 mb-xxl-8">
								...
								<div class="card-body p-5 p-md-8">
									...
									<div class="d-flex align-items-center">
										<!--begin::Symbol-->
										<div
											class="symbol symbol-40px symbol-md-50px me-5"
										>
											<span
											...
											>
												...
												<i
													class="fas fs-3x text-danger fa-tshirt"
												></i>
												<!--end::Svg Icon-->
											</span>
										</div>
										...
										<div>
											<a
												href="#"
												class="fs-4 text-dark text-hover-primary fw-bolder"
												>{{ stats.clothes }} Clothes</a
											>
											<div
												class="fs-7 text-white opacity-75 fw-bold mt-1"
											>
												<select
													onchange="onChange('clothes', this.value)"
								...
								<div class="card-body p-5 p-md-8">
									...
									<div class="d-flex align-items-center">
										...
										<div>
											<a
												href="#"
												class="fs-4 text-gray-800 text-hover-primary fw-bolder"
												>{{ stats.washed }} Washed</a
											>
											<div
												class="fs-7 text-white opacity-75 fw-bold mt-1"
											>
												<select
													onchange="onChange('washed', this.value)"
													class="form-select form-select-solid form-select-sm"
													data-control="select2"
													data-placeholder="Today"
													data-hide-search="true"
									...
									<div class="d-flex align-items-center">
										...
										<div>
											<a
												href="#"
												class="fs-4 text-gray-800 text-hover-primary fw-bolder"
												>{{ stats.ironed }} Ironed</a
											>
											<div
												class="fs-7 text-white opacity-75 fw-bold mt-1"
											>
												<select
													onchange="onChange('ironed', this.value)"
													class="form-select form-select-solid form-select-sm"
													data-control="select2"
													data-placeholder="Today"
													data-hide-search="true"
								...
								<div class="card-body p-5 p-md-8">
									...
									<div class="d-flex align-items-center">
										...
										<div>
											...
											>
												<select
													onchange="onChange('dispensed', this.value)"
													class="form-select form-select-solid form-select-sm"
													data-control="select2"
													data-placeholder="Today"
													data-hide-search="true"
							...
							<div class="card card-stretch mb-5 mb-xxl-8">
								...
								>
									...
									>
										...
										>
										<span
											class="text-muted mt-2 fw-bold fs-6"
											>{{
												widget.data.reduce((r, c) => {
													return r + c;
												}, 0)
											}}
											Clothes</span
								...
								<div class="card-body pt-12">
									...
									<div
										...
										style="
											background-image: url('../assets/media/svg/illustrations/bg-1.svg');
										"
									>
										<div
										...
										<canvas
											id="kt_stats_widget_1_chart"
										></canvas>
									</div>
									<!--end::Chart-->
									<!--begin::Items-->
									<div
										class="d-flex flex-wrap justify-content-around pt-18"
									>
										<!--begin::Item-->
										<div
											v-for="(ele, index) in widget.data"
											class="m-3"
										>
											<span
												class="fw-bolder text-gray-800"
												>{{
													percentage(ele, widget.data)
												}}
												{{ widget.labels[index] }}</span
											>
											<span
												:style="
													'background-color: ' +
													...
													';'
												"
												class="w-25px h-5px d-block rounded mt-1"
											></span>
										</div>
										<!--end::Item-->
									</div>
								...
								>
									...
									>
										<h1 class="fw-bolder text-dark">
											Search for IDs or name
										</h1>
										<div class="fs-3 mb-8">
											ID search is exact while name is
											relative
										</div>
										<!--begin::Form-->
										<form
											...
											"
											class="d-flex flex-center py-0 px-6 bg-white rounded"
										>
											...
											<span
												@click="
													searchDB(search.limit, 0)
												"
												class="svg-icon text-hover-success svg-icon-1 svg-icon-primary"
											>
												<svg
													xmlns="http://www.w3.org/2000/svg"
													xmlns:xlink="http://www.w3.org/1999/xlink"
