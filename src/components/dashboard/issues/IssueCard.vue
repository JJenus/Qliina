<script setup>
	const props = defineProps(["issue", "user"]);
			...
			<div class="card-body">
				...
				<div class="d-flex align-items-center">
					...
					<div class="d-flex flex-column flex-grow-1">
						<a
							href="#"
							class="text-gray-800 text-hover-primary mb-1 fs-5 fw-bolder"
						>
							{{ issue.customerName }}
						</a>
						<span class="text-muted fw-bold"
							>Clothe id: {{ issue.clothe_id }}</span
						>
						<span class="text-muted fw-bold"
							>Date: {{ date(issue.created_at) }}</span
						>
					</div>
					<!--end::Info-->
				</div>
				...
				<div
					...
					class="d-flex mt-3 mb-1 align-items-center ps-4 pe-4"
				>
					<span>Status: </span>
					<div>
				...
				>
					...
					>
						<span class="indicator-label"> Resolve </span>
