			...
			<div class="card-body pb-0">
				...
				<div class="d-flex align-items-center">
					...
					<div class="d-flex flex-column flex-grow-1">
						<a
							href="#"
							class="text-gray-800 text-hover-primary mb-1 fs-6 fw-bolder"
						>
							{{ staff.name }}
						</a>
						<span class="fw-bold badge badge-light-dark">{{
							role
						}}</span>
				...
				<div class="pt-5">
					...
					<div
						class="d-flex justify-content-start flex-wrap px-2 mb-3"
					>
						<span
							v-for="(role, index) in staff.roles"
							:key="index"
							class="badge mb-2 me-1 badge-light-dark"
						>
							{{ role }}
							<span
								@click="remove('role', index)"
								class="badge text-hover-danger ms-3 badge-light-danger"
							>
					...
					<div
						class="d-flex d-none justify-content-start flex-wrap px-2 mb-3"
					>
						<span
							v-for="(perm, index) in staff.permissions"
							:key="index"
							class="badge mb-2 me-1 badge-light-dark"
						>
							{{ permission(perm) }}
							<span
								@click="remove('permission', perm)"
								class="badge text-hover-danger ms-3 badge-light-danger"
							>
								<i class="fas fa-times"></i>
							</span>
