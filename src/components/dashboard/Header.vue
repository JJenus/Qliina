	...
	>
		...
		>
			...
			<div class="d-flex align-items-center">
				...
				<a href="/app/dashboard">
					...
					<img
						class="d-none"
						alt="Logo"
						src="/assets/media/logos/logo-default.svg h-30px"
					/>
				</a>
				<!--end::Logo-->
			</div>
			...
			<div class="d-flex align-items-center">
				<!--begin::Message-->
				<button
					class="btn d-none btn-icon btn-sm btn-active-bg-accent ms-1 ms-lg-6"
					data-bs-toggle="modal"
				...
				<div class="ms-1 ms-lg-6">
					...
					<!--begin::Menu-->
					<div
						class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold"
						data-kt-menu="true"
					>
						<!--begin::Row-->
						<div class="row g-0">
				...
				<div class="ms-1 d-none ms-lg-6">
					...
					>
						<div class="menu-item mx-3">
							<div
								class="menu-content fs-6 text-dark fw-bolder py-6"
							>
								4 New Notifications
							</div>
						</div>
						...
						<div class="menu-item mx-2">
							<div class="menu-content py-5">
								<a
									href="#"
									class="btn btn-primary fw-bolder me-2 px-5"
									>Report</a
								>
